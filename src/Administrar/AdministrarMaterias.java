 ...
 * @author margaroth
 */
public class AdministrarMaterias extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(cb_planes, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 10, 180, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel10.setText("Plan de Estudio");
        jPanel3.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 10, 110, 20));
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 1040, 550));

        jLabel18.setFont(new java.awt.Font("Ubuntu", 1, 18)); // NOI18N
        jLabel18.setText("Administrar Materias");
    ...
    private void cb_planesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_planesActionPerformed
        ...
        try {
            connection conn = new connection();
            ResultSet rs = conn.conectar("SELECT clv_materia,cuatrimestre,posicion,nombre_materia FROM materias WHERE clv_plan = '" + clave + "';");
            while (rs.next()) {
                ...
                tabla_jt.setValueAt("<html><body>"+nombre+"<br><br></body></html>", posicion - 1, cuatri - 1);
            }
        } catch (Exception e) {
        }
    ...
    private void tabla_jtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_jtMouseClicked
        ...
        //Obtener posicion de la fila y columna seleccionada
        int fila = tabla_jt.rowAtPoint(evt.getPoint());
        int columna = tabla_jt.columnAtPoint(evt.getPoint());

        boolean hay_valor = false;

        if (tabla_jt.getValueAt(fila, columna) == null) {
            hay_valor = false;
        } else {
            hay_valor = true;
        }

        String cuatri = columna + 1 + "";
        String posicion = fila + 1 + "";
        String plan = (String) cb_planes.getSelectedItem();

        DarDeAltaMaterias abrir = new DarDeAltaMaterias(hay_valor, cuatri, posicion, plan);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministrarMaterias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministrarMaterias().setVisible(true);
